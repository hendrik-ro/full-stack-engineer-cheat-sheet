...
export default function Page() {
  return <div>
    <div id="react">
        <h1>React</h1>
      <p><a target="_blank" href="https://react.dev/">React</a> is a JavaScript library for building user interfaces.</p>
      <p>It is component-based, allowing developers to create reusable UI components.</p>
      <p>React efficiently updates and renders the right components when data changes, using a virtual DOM to improve performance.</p>
    ...
    <div id="react-frameworks">
      ...
      <p><Link href="/front-end/react/next-js">Next.js</Link></p>
      <p><Link href="/front-end/react/vite">Vite</Link></p>
    </div>
  </div>;
}
